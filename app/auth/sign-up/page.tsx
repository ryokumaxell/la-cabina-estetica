      ...
      <div className="w-full max-w-sm">
        <div className="flex flex-col gap-6">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-rose-900 mb-2">Estética Pro</h1>
            <p className="text-rose-600">Sistema de Gestión Profesional</p>
          </div>
          <Card className="border-rose-200">
            <CardHeader>
              <CardTitle className="text-2xl text-rose-900">Crear Cuenta</CardTitle>
              <CardDescription>Registra tu cuenta profesional</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSignUp}>
                ...
                <div className="mt-4 text-center text-sm">
                  ¿Ya tienes cuenta?{" "}
                  <Link href="/auth/login" className="underline underline-offset-4 text-rose-600">
                    Iniciar Sesión
                  </Link>
                </div>
              </form>
