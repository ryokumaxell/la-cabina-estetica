...
export function ProcedureForm() {
  ...
  const handleInputChange = (field: keyof ProcedureFormData, value: string | boolean) => {
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Requisitos previos al tratamiento (ej: piel sin heridas abiertas, consulta previa...)"
                rows={3}
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Situaciones en las que no se debe realizar el tratamiento (ej: embarazo, lactancia...)"
                rows={3}
              />
            </div>
          </CardContent>
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Instrucciones detalladas para el cuidado posterior (ej: evitar exposición solar, aplicar protector...)"
                rows={4}
              />
            </div>
          </CardContent>
        ...
        <div className="flex justify-end space-x-4">
          <Button type="button" variant="outline" asChild>
            <Link href="/procedures">Cancelar</Link>
          </Button>
